  ...
  return (
    <div className="max-w-4xl mx-auto px-6 text-center">
      ...
      <p className="text-cream/60 text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-10">
        We&apos;re a team of students from the University of Toronto who experienced
        firsthand how broken dating apps are. We built Yuni because we believe meeting
        people should be fun, social, and pressure-free &mdash; the way it happens naturally
        on campus, not through a screen.
      </p>
