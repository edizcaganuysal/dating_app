...
export default function Preloader({ progress, firstFrameLoaded, onComplete }: PreloaderProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 z-[100] bg-[#241C1A] flex flex-col items-center justify-center overflow-hidden"
      ...
      {!countdownDone && (
        <div className="relative">
          <div
            ...
            style={{
              textShadow: "0 0 80px rgba(196,0,24,0.15), 0 0 160px rgba(196,0,24,0.05)",
      ...
      {countdownDone && (
        <div ref={revealTextRef} className="text-center opacity-0">
          ...
          <h2
            ...
            style={{ textShadow: "0 0 60px rgba(196,0,24,0.1)" }}
          >
            Discover Yuni
          </h2>
